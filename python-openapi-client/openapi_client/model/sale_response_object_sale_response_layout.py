...
class SaleResponseObjectSaleResponseLayout(ModelNormal):
    ...
    attribute_map = {
        ...
        'encode_type': 'EncodeType',  # noqa: E501
        'data': 'Data',  # noqa: E501
    }
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """SaleResponseObjectSaleResponseLayout - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            attribute ([str]): Posibles atributos de impresión que se aplicarán en el Data. En caso de no estar presente el elemento se imprime el texto en el tamaño predefinido como normal y con justificación a la izquierda (LeftJustified).. [optional]  # noqa: E501
            ...
            encode_type (str): Tipo de codificación de los datos. En caso de no estar presente el elemento se asume que el elemento Data está codificado como Plain.. [optional]  # noqa: E501
            data (str): Dato a imprimir codificado según los valores presentes en ContentType y EncodeType.. [optional]  # noqa: E501
        """
