...
class PaymentMethodObjectPaymentMethod(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'payment_method_foreign_identifier': (int,),  # noqa: E501
            'orig_transaction_type': (str,),  # noqa: E501
            'issuer': (str,),  # noqa: E501
            'get_dinamic_plans': (float,),  # noqa: E501
    ...
    attribute_map = {
        ...
        'payment_method_foreign_identifier': 'PaymentMethodForeignIdentifier',  # noqa: E501
        'orig_transaction_type': 'OrigTransactionType',  # noqa: E501
        'issuer': 'Issuer',  # noqa: E501
        'get_dinamic_plans': 'GetDinamicPlans',  # noqa: E501
    ...
    def _from_openapi_data(cls, company_identification, system_identification, *args, **kwargs):  # noqa: E501
        """PaymentMethodObjectPaymentMethod - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            transaction_type (str): Tipo de Transacción (Sale, Void, Return, Authorize,...) por la cual se está realizado el requerimiento. [optional]  # noqa: E501
            ...
            payment_method_id (int): ID del  metodo de pago que se requerie la información. [optional]  # noqa: E501
            payment_method_foreign_identifier (int): ID externo de este metodo de pago, utilizado por el punto de venta para reconocer al medio de pago en su base de datos. [optional]  # noqa: E501
            orig_transaction_type (str): Tipo de operación financiera a la cual se pretende anular o devolver, para la cual se pretende utilizar esta lectura de tarjeta. Este campo sera de uso obligatorio solo para determinados tipos de dispositivos de captura.. [optional]  # noqa: E501
            issuer (str): ID del emisor que se encuentra disponible para este plan. [optional]  # noqa: E501
            get_dinamic_plans (float): Flag utilizado para indicar si se quiere conocer los planes dinamicos tambien, como Plan V de Prisma.. [optional]  # noqa: E501
