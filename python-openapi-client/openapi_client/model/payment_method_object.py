...
def lazy_import():
    ...
    globals()['PaymentMethodObjectPaymentMethod'] = PaymentMethodObjectPaymentMethod


class PaymentMethodObject(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'payment_method': (PaymentMethodObjectPaymentMethod,),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """PaymentMethodObject - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            payment_method (PaymentMethodObjectPaymentMethod): [optional]  # noqa: E501
        """
