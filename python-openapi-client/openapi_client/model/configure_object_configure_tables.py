...
class ConfigureObjectConfigureTables(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """ConfigureObjectConfigureTables - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            id (str): Identificador de tabla. [optional]  # noqa: E501
            description (str): Descripción de la Tabla. [optional]  # noqa: E501
            version (str): Versión de la Tabla. [optional]  # noqa: E501
            data ({str: (bool, date, datetime, dict, float, int, list, str, none_type)}): Representación de la tabla, codificado en Base64 en caso de no ser JSON el mismo. [optional]  # noqa: E501
