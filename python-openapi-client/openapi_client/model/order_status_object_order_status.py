...
class OrderStatusObjectOrderStatus(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, company_identification, system_identification, amount, card_read_mode, *args, **kwargs):  # noqa: E501
        """OrderStatusObjectOrderStatus - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, company_identification, system_identification, amount, card_read_mode, *args, **kwargs):  # noqa: E501
        """OrderStatusObjectOrderStatus - a model defined in OpenAPI
