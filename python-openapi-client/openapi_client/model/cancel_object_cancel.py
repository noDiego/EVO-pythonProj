...
class CancelObjectCancel(ModelNormal):
    ...
    def _from_openapi_data(cls, company_identification, system_identification, *args, **kwargs):  # noqa: E501
        """CancelObjectCancel - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            reason (str): Motivo por el cual se requiere Cancelar.. [optional]  # noqa: E501
