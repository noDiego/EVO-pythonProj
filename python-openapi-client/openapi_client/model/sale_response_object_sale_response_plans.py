...
def lazy_import():
    ...
    globals()['SaleResponseObjectSaleResponsePlansCashback'] = SaleResponseObjectSaleResponsePlansCashback
    globals()['SaleResponseObjectSaleResponsePlansDeferral'] = SaleResponseObjectSaleResponsePlansDeferral


class SaleResponseObjectSaleResponsePlans(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            'id': (str,),  # noqa: E501
            'plan_code': (str,),  # noqa: E501
            'foreign_identifier': (str,),  # noqa: E501
            ...
            'offline_amount_limit': (float,),  # noqa: E501
            'deferral': (SaleResponseObjectSaleResponsePlansDeferral,),  # noqa: E501
            'cashback': (SaleResponseObjectSaleResponsePlansCashback,),  # noqa: E501
            'tna': (float,),  # noqa: E501
            'tem': (float,),  # noqa: E501
            'tea': (float,),  # noqa: E501
            'cft': (float,),  # noqa: E501
    ...
    attribute_map = {
        'id': 'Id',  # noqa: E501
        'plan_code': 'PlanCode',  # noqa: E501
        'foreign_identifier': 'ForeignIdentifier',  # noqa: E501
        ...
        'offline_amount_limit': 'OfflineAmountLimit',  # noqa: E501
        'deferral': 'Deferral',  # noqa: E501
        'cashback': 'Cashback',  # noqa: E501
        'tna': 'TNA',  # noqa: E501
        'tem': 'TEM',  # noqa: E501
        'tea': 'TEA',  # noqa: E501
        'cft': 'CFT',  # noqa: E501
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """SaleResponseObjectSaleResponsePlans - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            id (str): Identificador interno formado por el TEF por una combinación de datos del plan especifico. Si el plan no posee un código de emisor, el último campo no estará presente (ni el _).. [optional]  # noqa: E501
            plan_code (str): código de el plan.. [optional]  # noqa: E501
            foreign_identifier (str): ID externo para que el punto de venta pueda reconocer el plan.. [optional]  # noqa: E501
            issuer (str): ID del emisor que se encuentra disponible para este plan.. [optional]  # noqa: E501
            description (str): Descripción del plan.. [optional]  # noqa: E501
            facility_payments (int): Cantidad de cuotas que permite este plan. [optional]  # noqa: E501
            ...
            rate (float): Porcentaje de recargo completo para el monto de la operación.. [optional]  # noqa: E501
            amount (float): Monto debido al porcentaje de recargo.. [optional]  # noqa: E501
            offline_amount_limit (float): Monto máximo para operar de forma OFFLINE.. [optional]  # noqa: E501
            deferral (SaleResponseObjectSaleResponsePlansDeferral): [optional]  # noqa: E501
            cashback (SaleResponseObjectSaleResponsePlansCashback): [optional]  # noqa: E501
            tna (float): Se informará la tasa nominal anual, en casos en que el plan elegido para realizar la venta lo posea. Por ejemplo, el plan especial llamado Plan V de Prisma informará este valor, dado que se obtendrá dinámicamente, consultandolo instante a instante.. [optional]  # noqa: E501
            tem (float): Se informará la tasa efectiva mensual, en casos en que el plan elegido para realizar la venta lo posea. . [optional]  # noqa: E501
            tea (float): Tasa Efectiva anual. Este campo estará presente solo si el tipo de plan es dinámico, o si fue ingresado un valor en la base de datos.. [optional]  # noqa: E501
            cft (float): Costo Financiero Total. Este campo estará presente solo si el tipo de plan es dinámico, o si fue ingresado un valor en la base de datos.        . [optional]  # noqa: E501
            ...
            issuer_name (str): Nombre del emisor de este plan. Estará presente solo si existe un solo emisor para todos los planes, o si el plan es dinámico. [optional]  # noqa: E501
            is_dynamic (bool): Flag que indica si el plan es del tipo dinamico o no. [optional]  # noqa: E501
            category (str): Campo que le permite al punto de venta elegir entre un plan u otro. [optional]  # noqa: E501
