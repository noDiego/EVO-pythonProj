...
def lazy_import():
    ...
    globals()['SaleObjectSaleValues'] = SaleObjectSaleValues


class SaleObjectSaleSecurity(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            'type': (str,),  # noqa: E501
            'values': ([SaleObjectSaleValues],),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """SaleObjectSaleSecurity - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            type (str): Tipo de seguridad. [optional]  # noqa: E501
            values ([SaleObjectSaleValues]): Parámetros. [optional]  # noqa: E501
        """
