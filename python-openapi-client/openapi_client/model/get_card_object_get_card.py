...
class GetCardObjectGetCard(ModelNormal):
    ...
    def _from_openapi_data(cls, company_identification, system_identification, *args, **kwargs):  # noqa: E501
        """GetCardObjectGetCard - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            transaction_type (str): Tipo de Transacción (Sale, Void, Return, Authorize,...) por la cual se está realizado el requerimiento (Usado en GetCard). [optional]  # noqa: E501
