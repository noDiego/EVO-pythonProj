...
class SaleResponseObjectSaleResponsePaymentMethodDebitAccount(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """SaleResponseObjectSaleResponsePaymentMethodDebitAccount - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            id (bool, date, datetime, dict, float, int, list, str, none_type): ID interno para cada tipo de tarjeta de débito o tarjetas con tipo de cuenta. [optional]  # noqa: E501
            description (str): Descripción del tipo de tarejta de débito o tarjetas con tipo de cuenta. [optional]  # noqa: E501
        """
