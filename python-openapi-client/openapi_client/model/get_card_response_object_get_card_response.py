...
class GetCardResponseObjectGetCardResponse(ModelNormal):
    ...
    def _from_openapi_data(cls, response_code, response_actions, response_message, *args, **kwargs):  # noqa: E501
        """GetCardResponseObjectGetCardResponse - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            security_code (str): código de seguridad de la tarjeta. Este dato solo sera requerido si la parametrización de la marca a la que la tarjeta corresponde lo indique.. [optional]  # noqa: E501
            card_cryptogram (str): Criptograma obtenido del Chip. [optional]  # noqa: E501
