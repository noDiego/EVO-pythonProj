...
def lazy_import():
    ...
    globals()['GetBlockObjectGetBlock'] = GetBlockObjectGetBlock


class GetBlockObject(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'get_block': (GetBlockObjectGetBlock,),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """GetBlockObject - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            get_block (GetBlockObjectGetBlock): [optional]  # noqa: E501
        """
