...
class GetBlockObjectGetBlockTransactionsRequired(ModelNormal):
    ...
    allowed_values = {
        ('transaction_type',): {
            ...
            'VOIDDEBTPAYMENT': "VoidDebtPayment",
            'VALIDATE': "Validate",
        },
        ('state',): {
            'RETURNED': "Returned",
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """GetBlockObjectGetBlockTransactionsRequired - a model defined in OpenAPI
