...
def lazy_import():
    ...
    globals()['DebtPaymentObjectDebtPaymentRequiredInformation'] = DebtPaymentObjectDebtPaymentRequiredInformation
...
class DebtPaymentObjectDebtPayment(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'block': (str,),  # noqa: E501
            'required_information': ([DebtPaymentObjectDebtPaymentRequiredInformation],),  # noqa: E501
            ...
            'debt_company_identification': (str,),  # noqa: E501
    ...
    attribute_map = {
        ...
        'debt_company_identification': 'DebtCompanyIdentification',  # noqa: E501
    ...
    def _from_openapi_data(cls, company_identification, system_identification, amount, *args, **kwargs):  # noqa: E501
        """DebtPaymentObjectDebtPayment - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            required_information ([DebtPaymentObjectDebtPaymentRequiredInformation]): En caso de que se requiera información adicional para poder completar la operación, como podrían ser ciertos datos ingresados por el vendedor para realizar verificaciones especificas (como los últimos 4 digitos), el código de seguridad de la tarjeta o la fecha de vencimiento, este elemento estará presente.. [optional]  # noqa: E501
            ...
            reading_device_geo (str): Coordenadas Geograficas del dispositivo de lectura. [optional]  # noqa: E501
            ...
            facility_payments (float): Cantidad de cuotas en las que sera realizada la transacción. [optional]  # noqa: E501
            ...
            debt_company_identification (str): Identificador de la compania obtenido a la cual se quiere pagar la deuda .. [optional]  # noqa: E501
