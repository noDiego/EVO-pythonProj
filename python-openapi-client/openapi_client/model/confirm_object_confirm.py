...
class ConfirmObjectConfirm(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, company_identification, system_identification, sequence, *args, **kwargs):  # noqa: E501
        """ConfirmObjectConfirm - a model defined in OpenAPI
        ...
        Args:
            ...
            sequence (str): Retornado en todas las respuesta que el POS/PINPAD debe enviar en el próximo requerimiento. En caso de que el POS no lo envíe, envíe vacío o con un valor que no corresponde se produce “La Ruptura de Secuencia” y la plataforma si la última transacción que realizó el POS no esta confirmada y esta Aprobada genera entonces una reversa de la misma.
    ...
    @convert_js_args_to_python_args
    def __init__(self, company_identification, system_identification, sequence, *args, **kwargs):  # noqa: E501
        """ConfirmObjectConfirm - a model defined in OpenAPI
