...
class SettlementObjectSettlement(ModelNormal):
    ...
    attribute_map = {
        ...
        'orig_block': 'OrigBlock',  # noqa: E501
    ...
    def _from_openapi_data(cls, company_identification, system_identification, *args, **kwargs):  # noqa: E501
        """SettlementObjectSettlement - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            amount_charged (float): Importe o Monto de la Transacción que efectivamente se cobro , si se envía en Void o Return en lugar de Amount, se genera un Ajuste si el Host lo soporta.. [optional]  # noqa: E501
            ...
            orig_block (str): Identificador de Bloque que se quiere recuperar la información de su composición con la operación GetBlock, Void, Return.. [optional]  # noqa: E501
