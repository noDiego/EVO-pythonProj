...
class AuthorizeSaleObjectAuthorizeSale(ModelNormal):
    ...
    attribute_map = {
        ...
        'reason_reverse': 'ReasonReverse',  # noqa: E501
    ...
    def _from_openapi_data(cls, company_identification, system_identification, amount, *args, **kwargs):  # noqa: E501
        """AuthorizeSaleObjectAuthorizeSale - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            reason_reverse (str): Motivo por el cual se requiere generar la reversa.. [optional]  # noqa: E501
