...
def lazy_import():
    ...
    globals()['ConfigureObjectConfigure'] = ConfigureObjectConfigure


class ConfigureObject(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'configure': (ConfigureObjectConfigure,),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """ConfigureObject - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            configure (ConfigureObjectConfigure): [optional]  # noqa: E501
        """
