...
def lazy_import():
    ...
    globals()['SaleResponseObjectSaleResponsePaymentMethodCategory'] = SaleResponseObjectSaleResponsePaymentMethodCategory
    globals()['SaleResponseObjectSaleResponsePaymentMethodDebitAccount'] = SaleResponseObjectSaleResponsePaymentMethodDebitAccount
    globals()['SaleResponseObjectSaleResponsePaymentMethodIssuers'] = SaleResponseObjectSaleResponsePaymentMethodIssuers
    globals()['SaleResponseObjectSaleResponsePaymentMethodType'] = SaleResponseObjectSaleResponsePaymentMethodType


class SaleResponseObjectSaleResponsePaymentMethod(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'type': (SaleResponseObjectSaleResponsePaymentMethodType,),  # noqa: E501
            'debit_account': (SaleResponseObjectSaleResponsePaymentMethodDebitAccount,),  # noqa: E501
            'category': (SaleResponseObjectSaleResponsePaymentMethodCategory,),  # noqa: E501
            'issuers': ([SaleResponseObjectSaleResponsePaymentMethodIssuers],),  # noqa: E501
        }
    ...
    attribute_map = {
        ...
        'type': 'Type',  # noqa: E501
        'debit_account': 'DebitAccount',  # noqa: E501
        'category': 'Category',  # noqa: E501
        'issuers': 'Issuers',  # noqa: E501
    }
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """SaleResponseObjectSaleResponsePaymentMethod - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            id (int): ID interno en la base de datos para este método de pago.. [optional]  # noqa: E501
            foreign_identifier (str): ID externo de este método de pago, utilizado por el punto de venta para reconocer el medio de pago en su base de datos.. [optional]  # noqa: E501
            description (str): Describe al metodo de pago.. [optional]  # noqa: E501
            type (SaleResponseObjectSaleResponsePaymentMethodType): [optional]  # noqa: E501
            debit_account (SaleResponseObjectSaleResponsePaymentMethodDebitAccount): [optional]  # noqa: E501
            category (SaleResponseObjectSaleResponsePaymentMethodCategory): [optional]  # noqa: E501
            issuers ([SaleResponseObjectSaleResponsePaymentMethodIssuers]): Cada elemento de este array representa a un emisor disponible para alguno de los planes informados bank.. [optional]  # noqa: E501
        """
