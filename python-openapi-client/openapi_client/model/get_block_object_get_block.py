...
def lazy_import():
    ...
    globals()['GetBlockObjectGetBlockTransactionsRequired'] = GetBlockObjectGetBlockTransactionsRequired
    globals()['SaleObjectSaleSecurity'] = SaleObjectSaleSecurity


class GetBlockObjectGetBlock(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'transactions_required': ([GetBlockObjectGetBlockTransactionsRequired],),  # noqa: E501
        }
    ...
    attribute_map = {
        ...
        'transactions_required': 'TransactionsRequired',  # noqa: E501
    }
    ...
    def _from_openapi_data(cls, company_identification, system_identification, *args, **kwargs):  # noqa: E501
        """GetBlockObjectGetBlock - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            request_key (str): Identificador del Requermiento obtenido en la respuesta de la operación WalletRequest.            . [optional]  # noqa: E501
            ...
            transactions_required ([GetBlockObjectGetBlockTransactionsRequired]): Permite especificarLas transacciones requeridas y su estado. [optional]  # noqa: E501
        """
