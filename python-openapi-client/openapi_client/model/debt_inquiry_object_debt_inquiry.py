...
class DebtInquiryObjectDebtInquiry(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'pin': (str,),  # noqa: E501
            'card_last_four_digits': (str,),  # noqa: E501
    ...
    attribute_map = {
        ...
        'pin': 'Pin',  # noqa: E501
        'card_last_four_digits': 'CardLastFourDigits',  # noqa: E501
    ...
    def _from_openapi_data(cls, company_identification, system_identification, *args, **kwargs):  # noqa: E501
        """DebtInquiryObjectDebtInquiry - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            track1 (str): Banda Número 1 de la tarjeta. Este dato sera necesario si el modo de ingreso fue por banda (deslizando la banda por el lector).. [optional]  # noqa: E501
            track2 (str): Banda Número 2 de la tarjeta. Este dato sera necesario si el modo de ingreso fue por banda (deslizando la banda por el lector).. [optional]  # noqa: E501
            ...
            card_last_four_digits (str): últimos 4 digitos de la tarjeta, ingresado a partir de lo que el vendedor verifica en la superficie de la tarjeta. Este dato solo sera requerido para ciertos tipos de dispositivos de capturas, como por ejemplo lectores de tarjetas por emulación de teclado, y siempre y cuando la parametrización de la marca de la tarjeta asi lo indique.. [optional]  # noqa: E501
