...
class BlockCancelObjectBlockCancel(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'reading_device_type': (bool, date, datetime, dict, float, int, list, str, none_type,),  # noqa: E501
    ...
    attribute_map = {
        ...
        'foreign_block': 'ForeignBlock',  # noqa: E501
    }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, company_identification, system_identification, block, *args, **kwargs):  # noqa: E501
        """BlockCancelObjectBlockCancel - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            foreign_block (str): Identificador Alternativo de un  Bloque Que se informa en las operaciones BlockCancel o BlockClose.. [optional]  # noqa: E501
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, company_identification, system_identification, block, *args, **kwargs):  # noqa: E501
        """BlockCancelObjectBlockCancel - a model defined in OpenAPI
