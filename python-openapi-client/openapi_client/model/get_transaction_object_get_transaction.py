...
class GetTransactionObjectGetTransaction(ModelNormal):
    ...
    def _from_openapi_data(cls, company_identification, system_identification, *args, **kwargs):  # noqa: E501
        """GetTransactionObjectGetTransaction - a model defined in OpenAPI
