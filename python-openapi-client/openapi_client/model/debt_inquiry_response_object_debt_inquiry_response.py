...
def lazy_import():
    ...
    globals()['DebtInquiryResponseObjectDebtInquiryResponseAccountSummary'] = DebtInquiryResponseObjectDebtInquiryResponseAccountSummary
    globals()['DebtInquiryResponseObjectDebtInquiryResponseCompanies'] = DebtInquiryResponseObjectDebtInquiryResponseCompanies
...
class DebtInquiryResponseObjectDebtInquiryResponse(ModelNormal):
    ...
    validations = {
        ...
        ('reversed_payment_identification',): {
            'max_length': 128,
        },
    }
    ...
    def openapi_types():
        ...
        return {
            ...
            'account_summary': (DebtInquiryResponseObjectDebtInquiryResponseAccountSummary,),  # noqa: E501
            'debit_account_type': (str,),  # noqa: E501
            'account_number': (str,),  # noqa: E501
            'account_type': (str,),  # noqa: E501
            'acquirer_reference_data': (str,),  # noqa: E501
            'payment_identification': (str,),  # noqa: E501
            'fallback_forced': (int,),  # noqa: E501
            'reversed_payment_identification': (str,),  # noqa: E501
            'was_closed_previous_block': (int,),  # noqa: E501
            'identifier_for_the_acquirer': (str,),  # noqa: E501
            'companies': ([DebtInquiryResponseObjectDebtInquiryResponseCompanies],),  # noqa: E501
        }
    ...
    attribute_map = {
        ...
        'debit_account_type': 'DebitAccountType',  # noqa: E501
        'account_number': 'AccountNumber',  # noqa: E501
        'account_type': 'AccountType',  # noqa: E501
        'acquirer_reference_data': 'AcquirerReferenceData',  # noqa: E501
        'payment_identification': 'PaymentIdentification',  # noqa: E501
        'fallback_forced': 'FallbackForced',  # noqa: E501
        'reversed_payment_identification': 'ReversedPaymentIdentification',  # noqa: E501
        'was_closed_previous_block': 'WasClosedPreviousBlock',  # noqa: E501
        'identifier_for_the_acquirer': 'IdentifierForTheAcquirer',  # noqa: E501
    ...
    def _from_openapi_data(cls, response_code, response_actions, response_message, *args, **kwargs):  # noqa: E501
        """DebtInquiryResponseObjectDebtInquiryResponse - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            balance (str): Estado actual (saldo) de la cuenta. El formato de este valor utilizara las reglas del uso de signos de la matematica. Es decir, el signo \"+\" sera opcional cuando el salgo sea a favor (crédito), y sera obligatorio el uso del signo \"-\" cuando el saldo sea en contra (deudor). [optional]  # noqa: E501
            account_summary (DebtInquiryResponseObjectDebtInquiryResponseAccountSummary): [optional]  # noqa: E501
            debit_account_type (str): Descripción del tipo de cuenta de débito utilizada para realizar la transacción. Este tipo de dato es utilizado, por ejemplo, para tarjetas de la marca MAESTRO.. [optional]  # noqa: E501
            account_number (str): Número de cuenta informado por el host, relaciónado con la tarjeta que realizo la transacción. Este valor estara presente solo si ha sido solicitado al host al momento de enviar la petición.. [optional]  # noqa: E501
            account_type (str): Descripción del tipo de cuenta. [optional]  # noqa: E501
            acquirer_reference_data (str): Identificador de la transacción, utilizado solo por algunos hosts para realizar anulaciones y devoluciones. [optional]  # noqa: E501
            payment_identification (str): Código de identificación, generado por Plataforma, de la operación realizada. [optional]  # noqa: E501
            fallback_forced (int): Indicador de utilización de fallback para captura de los datos de tarjeta. Cuando se capturan los datos de una tarjeta EMV CHIP a traves de la banda magnética, este flag sera enviado, informando de esta situación. [optional]  # noqa: E501
            reversed_payment_identification (str): ID que identifica a la operación que acaba de ser reversada.. [optional]  # noqa: E501
            ...
            identifier_for_the_acquirer (str): Identificador de la transacción generado por Plataforma para ser enviado al Adquirente. [optional]  # noqa: E501
            companies ([DebtInquiryResponseObjectDebtInquiryResponseCompanies]): Companias . [optional]  # noqa: E501
        """
