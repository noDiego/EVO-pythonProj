...
class ConfigureObjectConfigureOperations(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'answer': ({str: (bool, date, datetime, dict, float, int, list, str, none_type)},),  # noqa: E501
    ...
    attribute_map = {
        ...
        'default_timeout': 'DefaultTimeout',  # noqa: E501
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """ConfigureObjectConfigureOperations - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            id (str): Identificador de tipo de Operación, Ej Sale. [optional]  # noqa: E501
            description (str): Descripción de la Operación. [optional]  # noqa: E501
            request ({str: (bool, date, datetime, dict, float, int, list, str, none_type)}): Especificación del requerimiento. [optional]  # noqa: E501
            answer ({str: (bool, date, datetime, dict, float, int, list, str, none_type)}): Especificación de la respuesta. [optional]  # noqa: E501
            default_timeout (int): Timeout por default para dicha operación expresado en milisegúndos. [optional]  # noqa: E501
            version (str): Versión de la transacción. [optional]  # noqa: E501
