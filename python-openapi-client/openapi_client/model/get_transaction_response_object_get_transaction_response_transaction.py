...
class GetTransactionResponseObjectGetTransactionResponseTransaction(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """GetTransactionResponseObjectGetTransactionResponseTransaction - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            response_code (int): Código de Respuesta Interno de la plataforma, el POS debe actuar por lo que indican las acciones especificadas en ResponseActions y no por el código de respuesta informado en este campo o elemento, pero es una buena práctica que sea persistido por el mismo.. [optional]  # noqa: E501
            ...
            merchant_id (str): Número de comercio utilizado para realizar la transacción. Este Número es asignado por el host, y parametrizado en la BD, relaciónado a cada uno de los planes disponibles.. [optional]  # noqa: E501
            terminal_id (int): Identificador de Terminal por el cual se envía la Transacción al Host.. [optional]  # noqa: E501
            ...
            currency_symbol (str): Simbolo monetario del tipo de cambio utilizado en la transacción. [optional]  # noqa: E501
