...
def lazy_import():
    ...
    globals()['EnrollmentObjectEnrollmentRecurrence'] = EnrollmentObjectEnrollmentRecurrence
...
class EnrollmentObjectEnrollment(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'recurrence': ([EnrollmentObjectEnrollmentRecurrence],),  # noqa: E501
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, company_identification, system_identification, *args, **kwargs):  # noqa: E501
        """EnrollmentObjectEnrollment - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            branch_identification (str): Identificador de Aplicativo para la Plataforma de Integración que usa la Compañía especificada.. [optional]  # noqa: E501
            pos_identification (str): Identificador del Punto de Venta/POS/Caja que pertenece a la sucursal y companía especificada.. [optional]  # noqa: E501
            recurrence ([EnrollmentObjectEnrollmentRecurrence]): Información de pagos recurrentes. [optional]  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, company_identification, system_identification, *args, **kwargs):  # noqa: E501
        """EnrollmentObjectEnrollment - a model defined in OpenAPI
