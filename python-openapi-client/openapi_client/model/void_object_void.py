...
class VoidObjectVoid(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, company_identification, system_identification, orig_answer_key, *args, **kwargs):  # noqa: E501
        """VoidObjectVoid - a model defined in OpenAPI
        ...
        Args:
            ...
            orig_answer_key (str): Identificador Unívoco de la Transacción que se quiere Referenciar, usado en Deposit, Void, Return, etc. O sea en las transacciones que hacen referencia a una Transacción previa. El valor fue obtenido en el campo o elemento AnswerKey de la Respuesta de la transacción referenciada. 
        ...
        self.orig_answer_key = orig_answer_key
    ...
    @convert_js_args_to_python_args
    def __init__(self, company_identification, system_identification, orig_answer_key, *args, **kwargs):  # noqa: E501
        """VoidObjectVoid - a model defined in OpenAPI
