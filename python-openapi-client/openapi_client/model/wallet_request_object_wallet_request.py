...
class WalletRequestObjectWalletRequest(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'transaction_identification': (str,),  # noqa: E501
            'trasaction_date_time': (str,),  # noqa: E501
            'transaction_timeout': (float,),  # noqa: E501
            ...
            'wallet_identification': (str,),  # noqa: E501
    ...
    attribute_map = {
        ...
        'transaction_identification': 'TransactionIdentification',  # noqa: E501
        'trasaction_date_time': 'TrasactionDateTime',  # noqa: E501
        'transaction_timeout': 'TransactionTimeout',  # noqa: E501
        ...
        'wallet_identification': 'WalletIdentification',  # noqa: E501
        ...
        'valid_thru': 'ValidThru',  # noqa: E501
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, system_identification, company_identification, *args, **kwargs):  # noqa: E501
        """WalletRequestObjectWalletRequest - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            branch_identification (str): ID de la sucursal, en caso de no existir ese concepto y ser un dispotivo que tiene posiciónamiento, deberá ser el mismo en caso contrario el mismo valor que el elemento <b>CompanyIdentification</b>. [optional]  # noqa: E501
            pos_identification (str): ID de la caja perteneciente a la sucursal indicada, en caso de no existir ese concepto y ser un dispotivo que tiene un identificador unico como por ejemplo el IMEI deberá viajar este.. [optional]  # noqa: E501
            request_type (str): Tipo de Requerimiento. Solo requerido para protocolos de transporte donde el tipo no se este especificando o en el PATH o en el tipo complejo que contiene al mismo. [optional]  # noqa: E501
            ...
            request_key (str): Identificador Privado para ser identificar la transacción a realizar, normalmente es un código a Presentar, solo sera enviado si ya fue creado por un WalletRequest previo y solamente queremos obtener los datos que pudo el Pagador Selecciónar, como el Medio de Pago para poder aplicar una promoción. [optional]  # noqa: E501
            ...
            transaction_type (str): Tipo de Transacción (Sale, Void, Return, Authorize,...) por la cual se está realizado el requerimiento (Usado en WalletRequest). [optional]  # noqa: E501
            transaction_description (str): Descripción del tipo de operación que se realizará. [optional]  # noqa: E501
            transaction_identification (str): ID de La transacción UNIVOCO para el Punto de venta. [optional]  # noqa: E501
            trasaction_date_time (str): Fecha y Hora de la transacción generada por el Punto de Venta - RFC3339 https://xml2rfc.tools.ietf.org/public/rfc/html/rfc3339.html#anchor14. [optional]  # noqa: E501
            transaction_timeout (float): Tiempo en segúndos que la transacción permanecera vigente. [optional]  # noqa: E501
            ...
            amount (float): Monto de la transacción a ser enviada. [optional]  # noqa: E501
            ...
            wallet_identification (str): Identificador del Wallet Retornado por la Operación Wallets. [optional]  # noqa: E501
            ...
            valid_thru (datetime): Fecha y Hora de fin de validez de La transacción - RFC3339 https://xml2rfc.tools.ietf.org/public/rfc/html/rfc3339.html#anchor14. [optional]  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, system_identification, company_identification, *args, **kwargs):  # noqa: E501
        """WalletRequestObjectWalletRequest - a model defined in OpenAPI
