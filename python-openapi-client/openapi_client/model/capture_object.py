...
def lazy_import():
    ...
    globals()['CaptureObjectCapture'] = CaptureObjectCapture


class CaptureObject(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'capture': (CaptureObjectCapture,),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """CaptureObject - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            capture (CaptureObjectCapture): [optional]  # noqa: E501
        """
