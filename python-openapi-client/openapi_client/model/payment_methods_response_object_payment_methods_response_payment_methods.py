...
def lazy_import():
    ...
    globals()['PaymentMethodsResponseObjectPaymentMethodsResponseCategory'] = PaymentMethodsResponseObjectPaymentMethodsResponseCategory
    globals()['PaymentMethodsResponseObjectPaymentMethodsResponseType'] = PaymentMethodsResponseObjectPaymentMethodsResponseType


class PaymentMethodsResponseObjectPaymentMethodsResponsePaymentMethods(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'card_number_max_length': (int,),  # noqa: E501
            'card_number_min_length': (int,),  # noqa: E501
            'security_code_max_length': (int,),  # noqa: E501
            'security_code_min_length': (int,),  # noqa: E501
            'description': (str,),  # noqa: E501
            'type': (PaymentMethodsResponseObjectPaymentMethodsResponseType,),  # noqa: E501
            'category': (PaymentMethodsResponseObjectPaymentMethodsResponseCategory,),  # noqa: E501
        }
    ...
    attribute_map = {
        ...
        'card_number_max_length': 'CardNumberMaxLength',  # noqa: E501
        'card_number_min_length': 'CardNumberMinLength',  # noqa: E501
        'security_code_max_length': 'SecurityCodeMaxLength',  # noqa: E501
        'security_code_min_length': 'SecurityCodeMinLength',  # noqa: E501
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """PaymentMethodsResponseObjectPaymentMethodsResponsePaymentMethods - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            id (int): ID interno en la base de datos para este metodo de pago. [optional]  # noqa: E501
            ...
            card_number_max_length (int): Longitud máxima del Número de tarjeta de este medio de pago. [optional]  # noqa: E501
            card_number_min_length (int): Longitud mínima del Número de tarjeta de este medio de pago. [optional]  # noqa: E501
            security_code_max_length (int): Longitud máxima del código de seguridad de tarjeta de este medio de pago. [optional]  # noqa: E501
            security_code_min_length (int): Longitud mínima del código de seguridad de tarjeta de este medio de pago. [optional]  # noqa: E501
            description (str): LIena que describe al metodo de pago. [optional]  # noqa: E501
            type (PaymentMethodsResponseObjectPaymentMethodsResponseType): [optional]  # noqa: E501
            category (PaymentMethodsResponseObjectPaymentMethodsResponseCategory): [optional]  # noqa: E501
        """
