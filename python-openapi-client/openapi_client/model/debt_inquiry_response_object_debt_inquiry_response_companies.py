...
class DebtInquiryResponseObjectDebtInquiryResponseCompanies(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """DebtInquiryResponseObjectDebtInquiryResponseCompanies - a model defined in OpenAPI
