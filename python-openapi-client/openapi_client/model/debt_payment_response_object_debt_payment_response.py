...
class DebtPaymentResponseObjectDebtPaymentResponse(ModelNormal):
    ...
    def _from_openapi_data(cls, response_actions, response_message, response_code, *args, **kwargs):  # noqa: E501
        """DebtPaymentResponseObjectDebtPaymentResponse - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            amount (float): Monto con la que se realizo transacción. [optional]  # noqa: E501
