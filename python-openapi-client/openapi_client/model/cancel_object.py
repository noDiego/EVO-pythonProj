...
def lazy_import():
    ...
    globals()['CancelObjectCancel'] = CancelObjectCancel


class CancelObject(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'cancel': (CancelObjectCancel,),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """CancelObject - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            cancel (CancelObjectCancel): [optional]  # noqa: E501
        """
