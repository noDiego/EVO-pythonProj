...
class SaleResponseObjectSaleResponseNotificationControlUseRule(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """SaleResponseObjectSaleResponseNotificationControlUseRule - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            id (str): Id del control de la regla. [optional]  # noqa: E501
            name (str): Nombre del control de la regla. [optional]  # noqa: E501
            template (str): Mensaje a enviar en la cadena de e-mails. En caso de no haber una notificación en ControlUse, se va a generar un objeto con los mensajes provenientes de Branch, Company, Channels y Platform en caso de que estos no se encuentren vacíos.. [optional]  # noqa: E501
        """
