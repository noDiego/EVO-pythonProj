...
class WalletRequestResponseObjectWalletRequestResponse(ModelNormal):
    ...
    allowed_values = {
        ('response_actions',): {
            ...
            'PAYMENTFLOWISCANCELABLE': "PaymentFlowIsCancelable",
            'DISPLAY': "Display",
            'PRINT': "Print",
        ...
        ('was_closed_previous_block',): {
            '0': 0,
            '1': 1,
        },
        ('wallet_request_token_type',): {
            'QR': "QR",
    ...
    def openapi_types():
        ...
        return {
            ...
            'was_closed_previous_block': (int,),  # noqa: E501
            ...
            'wallet_request_token': (str,),  # noqa: E501
            'wallet_request_token_type': (str,),  # noqa: E501
            'payment_method_identification': (str,),  # noqa: E501
            'foreign_payment_method_identification': (str,),  # noqa: E501
            'issuer_identification': (str,),  # noqa: E501
            'foreign_issuer_identification': (str,),  # noqa: E501
            'display_credential_identification': (str,),  # noqa: E501
    ...
    attribute_map = {
        ...
        'was_closed_previous_block': 'WasClosedPreviousBlock',  # noqa: E501
        ...
        'wallet_request_token': 'WalletRequestToken',  # noqa: E501
        'wallet_request_token_type': 'WalletRequestTokenType',  # noqa: E501
        'payment_method_identification': 'PaymentMethodIdentification',  # noqa: E501
        'foreign_payment_method_identification': 'ForeignPaymentMethodIdentification',  # noqa: E501
        'issuer_identification': 'IssuerIdentification',  # noqa: E501
        'foreign_issuer_identification': 'ForeignIssuerIdentification',  # noqa: E501
        'display_credential_identification': 'DisplayCredentialIdentification',  # noqa: E501
        ...
        'retry_time': 'RetryTime',  # noqa: E501
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, response_actions, response_message, response_code, answer_key, *args, **kwargs):  # noqa: E501
        """WalletRequestResponseObjectWalletRequestResponse - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            server_version (str): Versión del Servicio de la Plataforma que resolvió el requerimiento.. [optional]  # noqa: E501
            ...
            was_closed_previous_block (int): Flag indicador de cancelación o confirmación del último bloque de transacciones, previo al nuevo valor recibido. [optional]  # noqa: E501
            ...
            reversed_block (str): ID del bloque de transacciones que ha sido cancelado de forma automática (es decir, sin recibir un requerimiento de BlockClose). Este escenario se presentará si el Plataforma así se ha configurado para actuar bajo esa circunstancia.. [optional]  # noqa: E501
            ...
            transmition_date_time (datetime): Fecha y hora de transmision de la operación hacia el host - RFC3339 https://xml2rfc.tools.ietf.org/public/rfc/html/rfc3339.html#anchor14. [optional]  # noqa: E501
            ...
            trasaction_date_time (str): Fecha y Hora de la transacción en la plataforma de integración - RFC3339 https://xml2rfc.tools.ietf.org/public/rfc/html/rfc3339.html#anchor14. [optional]  # noqa: E501
            ...
            wallet_request_token (str): Identificador Publico para ser identificar la transacción a realizar, normalmente es un código a Presentar. [optional]  # noqa: E501
            wallet_request_token_type (str): Tipo de Identificador Público para ser identificar la transacción a realizar, normalmente es un código a Presentar. En el caso de JPG o PNG las mismas estaran codificadas en Base64. [optional]  # noqa: E501
            payment_method_identification (str): Metodo de Pago utilizado en el Pago. [optional]  # noqa: E501
            foreign_payment_method_identification (str): Metodo de Pago utilizado en el Pago expresado en la codificación que el aplicativo que se integra posea. [optional]  # noqa: E501
            issuer_identification (str): Emisor del Medio de Pago utilizado. [optional]  # noqa: E501
            foreign_issuer_identification (str): Emisor del Medio del Pago utilizado en el Pago expresado en la codificación que el aplicativo que se integra posea. [optional]  # noqa: E501
            display_credential_identification (str): Número o Identificador de Credencia que se puede Mostrar o Imprimir ( Normalmente Número de Tarjeta enmascarado para el caso de Tarjetas de Credito o débito). [optional]  # noqa: E501
            ...
            retry_time (int): Tiempo para el proximo reintento de la operación <b>WalletRequest</b> expresado en milisegúndos, si esta presenta la acción <b>Retry</b>. [optional]  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, response_actions, response_message, response_code, answer_key, *args, **kwargs):  # noqa: E501
        """WalletRequestResponseObjectWalletRequestResponse - a model defined in OpenAPI
