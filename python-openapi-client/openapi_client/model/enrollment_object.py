...
def lazy_import():
    ...
    globals()['EnrollmentObjectEnrollment'] = EnrollmentObjectEnrollment


class EnrollmentObject(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'enrollment': (EnrollmentObjectEnrollment,),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """EnrollmentObject - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            enrollment (EnrollmentObjectEnrollment): [optional]  # noqa: E501
        """
