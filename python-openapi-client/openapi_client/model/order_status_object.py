...
def lazy_import():
    ...
    globals()['OrderStatusObjectOrderStatus'] = OrderStatusObjectOrderStatus


class OrderStatusObject(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'order_status': (OrderStatusObjectOrderStatus,),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """OrderStatusObject - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            order_status (OrderStatusObjectOrderStatus): [optional]  # noqa: E501
        """
