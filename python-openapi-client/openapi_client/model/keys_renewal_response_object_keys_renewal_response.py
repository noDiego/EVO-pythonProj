...
class KeysRenewalResponseObjectKeysRenewalResponse(ModelNormal):
    ...
    def _from_openapi_data(cls, response_code, response_actions, response_message, *args, **kwargs):  # noqa: E501
        """KeysRenewalResponseObjectKeysRenewalResponse - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            sequence (str): Retornado en todas las respuestas que el POS/PINPAD debe enviar en el próximo requerimiento. En caso de que el POS no lo envíe, envíe vacío o con un valor que no corresponde se produce “La Ruptura de Secuencia” y la plataforma, si la última transacción que realizó el POS no esta confirmada y esta aprobada, genera una reversa de la misma.. [optional]  # noqa: E501
