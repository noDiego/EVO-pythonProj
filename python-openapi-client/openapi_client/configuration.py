...
conf = openapi_client.Configuration(
    ...
    def __init__(self, host=None,
        ...
        """Constructor
        """
        self._base_path = "https://testcodi.multipay.mx:30801/Payments/Authorize/5.6.1" if host is None else host
        """Default Base url
        """
    ...
    def get_host_settings(self):
        ...
        return [
            {
                'url': "https://testcodi.multipay.mx:30801/Payments/Authorize/5.6.1",
