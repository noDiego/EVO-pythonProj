...
**operation_mode** | **str** | Diferentes modos de ingresos para los cuales el plan puede ser utilizado | [optional] 
**operation_mode_description** | **str** | Descripción del campo OperationMode | [optional] 
