...
**security_code** | **str** | código de seguridad de la tarjeta. Este dato solo sera requerido si la parametrización de la marca a la que la tarjeta corresponde lo indique. | [optional] 
**card_cryptogram** | **str** | Criptograma obtenido del Chip | [optional] 
