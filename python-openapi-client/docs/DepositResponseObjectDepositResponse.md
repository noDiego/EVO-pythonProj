# DepositResponseObjectDepositResponse
...
**orig_auth_terminal_trace** | **int** | Número de terminal de la Transacción previa que se está referenciando. | [optional] 
**orig_auth_code** | **str** | Código de autorización de la transacción original. | [optional] 
