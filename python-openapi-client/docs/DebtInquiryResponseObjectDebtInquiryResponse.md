...
**card_holder_name** | **str** | Nombre del tarjetahabiente obtenido de la tarjeta. | [optional] 
**payment_method_id** | **int** | ID de la marca con la cual la tarjeta fue identificada | [optional] 
...
**account_summary** | [**DebtInquiryResponseObjectDebtInquiryResponseAccountSummary**](DebtInquiryResponseObjectDebtInquiryResponseAccountSummary.md) |  | [optional] 
**debit_account_type** | **str** | Descripción del tipo de cuenta de débito utilizada para realizar la transacción. Este tipo de dato es utilizado, por ejemplo, para tarjetas de la marca MAESTRO. | [optional] 
...
**payment_identification** | **str** | Código de identificación, generado por Plataforma, de la operación realizada | [optional] 
**fallback_forced** | **int** | Indicador de utilización de fallback para captura de los datos de tarjeta. Cuando se capturan los datos de una tarjeta EMV CHIP a traves de la banda magnética, este flag sera enviado, informando de esta situación | [optional] 
**reversed_payment_identification** | **str** | ID que identifica a la operación que acaba de ser reversada. | [optional] 
...
**companies** | [**[DebtInquiryResponseObjectDebtInquiryResponseCompanies]**](DebtInquiryResponseObjectDebtInquiryResponseCompanies.md) | Companias  | [optional] 
